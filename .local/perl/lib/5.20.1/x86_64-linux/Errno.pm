...
"x86_64-linux-2.6.32-431.29.2.el6.centos.plus.x86_64" or
	die "Errno architecture (x86_64-linux-2.6.32-431.29.2.el6.centos.plus.x86_64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
